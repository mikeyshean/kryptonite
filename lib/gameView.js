(function () {
  ...
  var GameView = window.Flappy.GameView = function (options) {
    ...
    this.$getLeaderes = this.$leaderboard.find(".view-leaders")
    this.$leaderList = this.$leaderboard.find(".leaderboard-list")
    this.$submitScore = this.$leaderboard.find(".submit")
    ...
    this.$submitScore.on("click", this.submitScore.bind(this))
    this.$leaderboard.on("click", this.getLeaders.bind(this))
